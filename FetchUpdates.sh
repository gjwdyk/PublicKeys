...
file_url[1]="https://apt.grafana.com/gpg.key](https://apt.grafana.com/gpg.key"
...
file_url[3]="https://cs.nginx.com/static/files/90pkgs-nginx](https://cs.nginx.com/static/files/90pkgs-nginx"
